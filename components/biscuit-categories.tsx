...
const categories = [
  {
    ...
    description: "Çay ve kahve yanında keyifle tüketebileceğiniz tatlı bisküvilerimiz.",
    products: ["Petit Beurre", "Finger", "Çikolatalı Bisküvi", "Yulaflı Bisküvi"],
  },
  {
    id: "kremali-biskuviler",
    ...
    products: ["Çikolatalı Kremalı", "Vanilyalı Kremalı", "Muzlu Kremalı", "Çilekli Kremalı"],
  },
  {
    id: "tuzlu-biskuviler",
    name: "Tuzlu Bisküviler",
    image: "/placeholder.svg?height=300&width=300&text=Tuzlu+Bisküviler",
    description: "Aperatif olarak tüketebileceğiniz lezzetli tuzlu bisküvilerimiz.",
    products: ["Tuzlu Kraker", "Peynirli Kraker", "Baharatlı Kraker", "Susamlı Kraker"],
  },
  {
    id: "saglikli-biskuviler",
    name: "Sağlıklı Bisküviler",
    image: "/placeholder.svg?height=300&width=300&text=Sağlıklı+Bisküviler",
    description: "Tam tahıllı, yüksek lifli ve düşük şekerli sağlıklı alternatifler.",
    products: ["Tam Tahıllı Bisküvi", "Yulaflı Bisküvi", "Kepekli Bisküvi", "Şeker İlavesiz Bisküvi"],
  },
]
  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-4">Bisküvi Kategorilerimiz</h2>
        <p className="text-gray-600 text-center max-w-2xl mx-auto mb-12">
          Farklı damak zevklerine hitap eden geniş bisküvi yelpazemizden size en uygun olanı seçin.
        </p>
