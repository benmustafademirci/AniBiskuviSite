    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 pt-[100px]">
        ...
        <section className="relative h-[300px] md:h-[400px]">
          <Image
            src="https://images.unsplash.com/photo-1590779033100-9f60a05a013d?q=80&w=1200&auto=format"
            alt="Krakerler"
            fill
          ...
          <div className="absolute inset-0 bg-black/40 flex flex-col justify-center">
            <div className="container mx-auto px-4">
              <div className="max-w-3xl">
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Krakerler</h1>
                <p className="text-white/90 text-lg md:text-xl">
                  Anı Bisküvi'nin özenle hazırladığı, çıtır çıtır krakerler ile atıştırmalık keyfi yaşayın.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-gray-100 py-3">
          <div className="container mx-auto px-4">
            <div className="flex items-center text-sm text-gray-600">
              ...
              <span className="font-medium text-[#e30613]">Krakerler</span>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-4">Kraker Dünyamıza Hoş Geldiniz</h2>
                <p className="text-gray-600 mb-4">
                  Anı Bisküvi Gıda San. ve Tic. A.Ş. olarak, çıtır çıtır dokusu ve enfes lezzetiyle öne çıkan, her ana
                  eşlik eden krakerler sunuyoruz.
                </p>
                <p className="text-gray-600 mb-6">
                  Tuzlu krakerlerden baharatlı krakerlere, peynirli krakerlerden çubuk krakerlere kadar geniş ürün
                  yelpazemizle her yaştan tüketicimizin damak zevkine hitap ediyoruz.
                </p>
                <div className="flex flex-wrap gap-4">
                  <Button className="bg-[#e30613] hover:bg-red-700">Tüm Krakerler</Button>
                  <Button
                    variant="outline"
              ...
              <div className="relative h-[300px] rounded-lg overflow-hidden">
                <Image
                  src="https://images.unsplash.com/photo-1590779033100-9f60a05a013d?q=80&w=500&text=Kraker+Üretimi"
                  alt="Kraker Üretimi"
                  fill
                  className="object-cover"
                />
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12">Öne Çıkan Krakerlerimiz</h2>
        ...
        <section className="py-16 bg-[#e30613]">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold text-white mb-6">Krakerlerimizi Denediniz mi?</h2>
            <p className="text-white/90 max-w-2xl mx-auto mb-8">
              Anı Bisküvi'nin lezzetli kraker dünyasını keşfedin. Tüm ürünlerimize en yakın satış noktasından
              ulaşabilirsiniz.
            </p>
